    ...
    return (
      <div className="h-screen flex items-center justify-center">
        <div className="bg-white p-5 rounded-md flex flex-col items-center justify-center w-[320px]">
          ...
          <button className="w-100 my-1 w-[280px] bg-white rounded-md shadow-xl py-2 flex items-center justify-center" onClick={()=>signIn('dex-provider')}><IconBrandGithub className="mx-2"/>Login with DEX </button>
          </div>
        </div>
      </div>
    );
